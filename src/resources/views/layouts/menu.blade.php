    ...
    @php
        ...
        */
        ...
        $menu = [
            ...
            ['route' => 'agenda',                     'label' => 'Agenda',                  'icon' => 'bi bi-calendar-week',       'roles' => ['Super Usuario', 'Administrador', 'Auxiliar', 'Conciliador', 'Notificador', 'Delegado', 'Excepcion', 'Enlace', 'Cumplimientos']],
            ...
            ['route' => 'audiencias.cumplimiento',    'label' => 'Cumplimientos',           'icon' => 'bi bi-cash-coin',           'roles' => ['Super Usuario', 'Auxiliar', 'Cumplimientos']],
            ...
            ['route' => 'notificaciones_consultar',   'label' => 'Notificaciones',          'icon' => 'bi bi-envelope',            'roles' => ['Estadistica', 'Enlace']],
            ['route' => 'index_oficialia',            'label' => 'Oficialía de Partes',     'icon' => 'bi bi-file-post',           'roles' => ['Super Usuario', 'Turnos', 'Excepcion']],
            ['route' => 'firma_citatorio',            'label' => 'Pendiente de Firma',      'icon' => 'bi bi-pencil-square',       'roles' => ['Super Usuario'], 'id' => 'menu-pendiente-firma', 'badge' => 'badge-pendiente-firma'],
            ...
            ['route' => 'notificaciones',             'label' => 'Por Notificar',           'icon' => 'bi bi-envelope-paper',      'roles' => ['Super Usuario', 'Administrador', 'Enlace']],
            ...
            ['route' => 'solicitudes_index',          'label' => 'Solicitudes',             'icon' => 'bi bi-file-earmark-text-fill', 'roles' => ['Super Usuario', 'Administrador', 'Auxiliar', 'Conciliador', 'Notificador', 'Estadistica', 'Enlace']],
