    ...
    @php
        ...
        */
        ...
        $menu = [
            ...
            ['route' => 'create_asesoria',            'label' => 'Asesorías',               'icon' => 'bi bi-person-check-fill',   'roles' => ['Super Usuario', 'Orientador', 'Enlace', 'Directivo']],
            ...
            ['route' => 'seer.estadistica',           'label' => 'Estadísticas',            'icon' => 'bi bi-clipboard-data-fill', 'roles' => ['Super Usuario', 'Auxiliar', 'Orientador', 'Administrador', 'Enlace', 'Estadistica', 'Directivo', 'Notificador', 'Delegado']],
            ...
            ['route' => 'notificaciones_consultar',   'label' => 'Notificaciones',          'icon' => 'bi bi-envelope',            'roles' => ['Estadistica', 'Enlace', 'Directivo']],
            ...
            ['route' => 'index_ratificacion',         'label' => 'Ratificaciones',          'icon' => 'bi bi-bank',                'roles' => ['Super Usuario', 'Administrador', 'Auxiliar', 'Conciliador', 'Estadistica', 'Enlace', 'Directivo']],
            ...
            ['route' => 'solicitudes_index',          'label' => 'Solicitudes',             'icon' => 'bi bi-file-earmark-text-fill', 'roles' => ['Super Usuario', 'Administrador', 'Orientador', 'Auxiliar', 'Conciliador', 'Notificador', 'Estadistica', 'Enlace', 'Cumplimientos', 'Directivo']],
