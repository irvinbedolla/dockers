                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 mb-3">
                                        ...
                                        @if (!empty($registro->imagen_domicilio1) && $registro->imagen_domicilio1 !== 'Sin documento')
                                            <a target='_blank' href="{{ signedDocRoute('documentos.ver', ['tipo' => 'solicitud', 'id' => $registro->id_solicitud, 'archivo' => $registro->imagen_domicilio1]) }}">VER IMAGEN</a>
                                        @else
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 mb-3">
                                        ...
                                        @if (!empty($registro->imagen_domicilio2) && $registro->imagen_domicilio2 !== 'Sin documento')
                                            <a target='_blank' href="{{ signedDocRoute('documentos.ver', ['tipo' => 'solicitud', 'id' => $registro->id_solicitud, 'archivo' => $registro->imagen_domicilio2]) }}">VER IMAGEN</a><br>
                                        @else
                                            <span class="text-muted">No se subió imagen</span>
                                        @endif
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 ">
                                            <div class="form-group">
                                                ...
                                                @if(!empty($registro->documento) && $registro->documento !== 'Sin documento')
                                                    <a target='_blank' href="{{ signedDocRoute('documentos.ver', ['tipo' => 'notificacion', 'id' => $registro->id_solicitud, 'archivo' => $registro->documento]) }}" class="badge badge-info mb-2">VER IMAGEN ACTUAL</a>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                @if(!empty($registro->documento1) && $registro->documento1 !== 'Sin documento')
                                                    <a target='_blank' href="{{ signedDocRoute('documentos.ver', ['tipo' => 'notificacion', 'id' => $registro->id_solicitud, 'archivo' => $registro->documento1]) }}" class="badge badge-info mb-2">VER IMAGEN ACTUAL</a>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                @if(!empty($registro->documento2) && $registro->documento2 !== 'Sin documento')
                                                    <a target='_blank' href="{{ signedDocRoute('documentos.ver', ['tipo' => 'notificacion', 'id' => $registro->id_solicitud, 'archivo' => $registro->documento2]) }}" class="badge badge-info mb-2">VER IMAGEN ACTUAL</a>
