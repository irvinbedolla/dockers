                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class='needs-validation novalidate' id='form_roles' method='POST' action="{{route('incidencias_update')}}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="motivo" value="{{ $incidencia->motivo }}">
