...
<head>
    @php
        ...
        if (request()->boolean('debug_session')) {
            dd([
                'view' => 'solicitud_trabajadorCentro',
                    ...
                    <div class="col-lg-12" >
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="{{route('parte1Centro')}}">
                                        @csrf
                                        ...
                                        <div align="center">
                                            ...
                                            <a href="{{ url()->previous() }}" class="btn btn-primary" style=" background-color:#CEA845;border-color: #CEA845">Regresar</a>    
                                        </div>
                                    </form>
                                </div>
                            </div>
