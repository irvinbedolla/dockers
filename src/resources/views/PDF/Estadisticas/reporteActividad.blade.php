    ...
    <body>
        ...
        <main>
            ...
            <table class="table-custom">
                <thead>
                    <tr>
                        <th width="70%">Actividad Economica</th>
                        <th width="30%" style="text-align: center;">Total de Solicitudes</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($solicutudes_actividad as $municipios)
                        <tr>
                            <td>{{ $municipios->actividad }}</td>
                            <td style="text-align: center;">
                            <span class="total-badge">{{ $municipios->total_solicitudes }}</span>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
