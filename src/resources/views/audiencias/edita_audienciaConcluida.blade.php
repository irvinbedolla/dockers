                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class='needs-validation novalidate' id='form_roles' method='POST' action="{{ route('Guarda_edicion_audienciaConcluida') }}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12"  style="border:1px solid black;">
                                        <div class="form-group">
                                            ...
                                            <textarea name="primera" class="form-control" required>{{ old('primera', $manifestaciones->resolicion_primera ?? '') }}</textarea>
                                    ...
                                    <div id="justificacion" ><br>
                                        <div class="col-xs-12 col-sm-12 col-md-12" style="border:1px solid black;">
                                            <div class="form-group">
                                                ...
                                                <textarea name="justificacion" class="form-control" required>{{ old('justificacion', $manifestaciones->resolicion_justificacion ?? '') }}</textarea>
                                                <div class="invalid-feedback">
                                                    El campo es obligatorio.
                                                </div>
                                            </div>
                                    ...
                                    <div id="segunda" ><br>
                                        <div class="col-xs-12 col-sm-12 col-md-12" style="border:1px solid black;">
                                            <div class="form-group">
                                                ...
                                                <textarea name="segunda" class="form-control" required>{{ old('segunda', $manifestaciones->resolicion_segunda ?? '') }}</textarea>
                                                <div class="invalid-feedback">
                                                    El campo es obligatorio.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6"><br>
                                            ...
                                            <select id="tipo_de_conclucion_visual" class="form-control" disabled>
                                                ...
                                                <option value="Conciliacion" @selected(old('conclucion', $manifestaciones->conclucion ?? '') == 'Conciliacion')>Hubo Convenio</option>
                                                <option value="No conciliacion" @selected(old('conclucion', $manifestaciones->conclucion ?? '') == 'No conciliacion')>No Hubo Convenio</option>
                                                {{--<option value="Reinstalacion" @selected(old('conclucion', $manifestaciones->conclucion ?? '') == 'Reinstalacion')>Reinstalación</option>--}}
                                            </select>
                                            <input type="hidden" name="conclucion" id="tipo_de_conclucion" value="{{ old('conclucion', $manifestaciones->conclucion ?? '') }}">
                                        </div>                                          
                                    </div>
                                    ...
                                    <div id="dias" class="row gx-2 align-items-end">
                                        <div class="col-xs-12 col-sm-12 col-md-2"><br>
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.001" name="vacaciones" class="form-control" value="{{ old('vacaciones', $manifestaciones->vacaciones ?? '') }}"> 
                                                <div class="invalid-feedback">
                                                    El campo es obligatorio.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-2"><br>
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.001" name="aguinaldo" class="form-control" value="{{ old('aguinaldo', $manifestaciones->aguinaldo ?? '') }}"> 
                                                <div class="invalid-feedback">
                                                    El campo es obligatorio.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-1">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.001" name="otros" class="form-control" value="{{ old('otros', $manifestaciones->otros ?? '') }}"> 
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="horario" maxlength="120" class="form-control" value="{{ old('horario', $manifestaciones->horario ?? '') }}">
                                                <div class="invalid-feedback">
                                                    El campo es obligatorio.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="comida" maxlength="50" class="form-control" value="{{ old('comida', $manifestaciones->comida ?? '') }}">
                                                <div class="invalid-feedback">
                                                    El campo es obligatorio.
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-6"><br>
                                                ...
                                                <select id="tipo_audiencia" name="tipo_audiencia" class="form-control">
                                                    <option value="">Seleccione</option>
                                                    <option value="Presencial" @selected(old('tipo_audiencia', $manifestaciones->tipo_audiencia ?? '') == 'Presencial')>Presencial</option>
                                                    <option value="Virtual" @selected(old('tipo_audiencia', $manifestaciones->tipo_audiencia ?? '') == 'Virtual')>Virtual</option>
                                                </select>
                                            </div> 
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
