...
<head>
    ...
    <link rel="icon" href="{{ asset('assets_seer/images/icono.png') }}" type="image/x-icon">

    <link href="{{ asset('assets_seer/assets/dist/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css"/>
